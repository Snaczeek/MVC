...
from .forms import BookForm, AuthorForm, BorrowForm, RegisterForm
...
def borrow_book(request, pk):
    ...
    if request.method == 'POST':
        ...
        book.save()
        messages.success(request, f'Wypożyczono: "{book.title}"')
        return redirect('book_list')
...
def return_book(request, pk):
    ...
    if request.method == 'POST':
        ...
        book.save()
        borrow.delete()
        messages.success(request, f'Zwrócono: "{book.title}"')
